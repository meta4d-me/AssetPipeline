...
public:
	...
	TMatrix<T, 4, 4> GetMatrix() const
	{
		...
		TMatrix<T, 4, 4> translation = cd::Matrix4x4::Identity();

		translation.GetColumn(3)[0] = m_translation.x();
		translation.GetColumn(3)[1] = m_translation.y();
		translation.GetColumn(3)[2] = m_translation.z();
