...
class CORE_API HalfEdgeMeshImpl
{
public:
	HalfEdgeMeshImpl();
	HalfEdgeMeshImpl(const HalfEdgeMeshImpl&) = delete;
	HalfEdgeMeshImpl& operator=(const HalfEdgeMeshImpl&) = delete;
	HalfEdgeMeshImpl(HalfEdgeMeshImpl&&);
