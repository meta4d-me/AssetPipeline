...
cd::MeshID GenericProducerImpl::AddMesh(cd::SceneDatabase* pSceneDatabase, const aiMesh* pSourceMesh)
{
	...
	{
		AddBone(pSceneDatabase, pSourceMesh, mesh);
	}
...
void GenericProducerImpl::AddBone(cd::SceneDatabase* pSceneDatabase, const aiMesh* pSourceMesh, cd::Mesh& mesh)
{
