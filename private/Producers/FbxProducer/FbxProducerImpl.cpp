...
void FbxProducerImpl::Execute(cd::SceneDatabase* pSceneDatabase)
{
	...
	// Stage 0 : Query SDK version and initialize Importer and IOSettings for opening file.
	...
	// Stage 1 : Query fbx file version and import file to scene.
	...
	// Stage 2 : Query scene information and prepare to import.
	...
	// Stage 3 : Convert fbx materials to cd materials.
	...
	// Stage 4 : Convert fbx scene nodes/meshes to cd scene nodes/meshes.
	...
	// Stage 5 : Convert fbx bone/joint to cd scene bone/joint.
...
cd::MeshID FbxProducerImpl::AddMesh(const fbxsdk::FbxNode* pSDKNode, cd::Node* pParentNode, cd::SceneDatabase* pSceneDatabase)
{
	...
	{
		printf("[Error] Please triangulate mesh before import.\n");
