...
void CDConsumer::ExportXmlBinary(const cd::SceneDatabase* pSceneDatabase, cd::EndianType targetEndian)
{
	m_pCDConsumerImpl->ExportXmlBinary(pSceneDatabase, targetEndian);
}
